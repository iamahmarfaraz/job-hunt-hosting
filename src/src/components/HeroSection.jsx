...
const HeroSection = () => {
  const [searchhInput, setSearchInput] = useState("");
  ...
  const submitHandler = () => {
    dispatch(setSearchedQuery(searchhInput));
    setSearchInput("");
    navigate("/jobs");
  };
      ...
      <AuroraBackground>
        ...
        >
          ...
          <div className="flex items-center text-center w-8/12 text-gray-700 font-extralight text-base md:text-4xl dark:text-neutral-200 py-4">
            Your journey to professional success begins here! At JobHunt, we
            empower you to discover exciting job opportunities, connect with
            leading companies, and achieve your career aspirations faster than
            ever before.
          </div>
          <div className="flex w-[40%] shadow-lg border bg-transparent border-gray-200 pl-3 rounded-full items-center gap-4 mx-auto">
            ...
            <Button
              ...
              className="rounded-r-full bg-no-repeat bg-gradient-to-r from-purple-500 via-violet-500 to-pink-500 "
            >
              <Search className="h-6 w-6 text-center"></Search>
            </Button>
          </div>
        </motion.div>
      </AuroraBackground>
